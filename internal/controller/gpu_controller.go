...
//+kubebuilder:rbac:groups=secret.wetee.app,resources=gpus,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=secret.wetee.app,resources=gpus/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=secret.wetee.app,resources=gpus/finalizers,verbs=update
